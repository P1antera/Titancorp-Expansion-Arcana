function init()
  ...
  self.itemName = config.getParameter("itemName", "at_ext_ice3")
  self.firstEffectName = config.getParameter("firstEffectName", "at_ext_ice3_1")
  self.firstEffectDuration = config.getParameter("firstEffectDuration", 60)
  self.secondEffectName = config.getParameter("secondEffectName", "at_ext_ice3_2")
  self.secondEffectDuration = config.getParameter("secondEffectDuration", 180)
  self.foodCost = config.getParameter("foodCost", 10)
...
function consumeFood()
  if self.foodCost <= 0 then
    return
  end

  pcall(function()
    status.modifyResource("food", -self.foodCost)
  end)
end
