function init()
  ...
  self.itemName = config.getParameter("itemName", "at_ext_water")
  self.effectName = config.getParameter("effectName", "at_ext_water")
  self.effectDuration = config.getParameter("effectDuration", 600)
