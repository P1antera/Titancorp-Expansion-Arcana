function init()
  ...
  self.itemName = config.getParameter("itemName", "at_ext_ice2")
  self.effectName = config.getParameter("effectName", "at_ext_ice2_1")
  self.effectDuration = config.getParameter("effectDuration", 30)
  self.effectsToClear = config.getParameter("effectsToClear", { self.effectName })
...
function finish()
  ...
  self.finished = true
  for _, effectName in ipairs(self.effectsToClear) do
