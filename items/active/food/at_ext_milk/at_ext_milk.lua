...
function init()
  ...
  self.itemName = config.getParameter("itemName", "at_ext_milk")
  self.effectName = config.getParameter("effectName", "at_ext_milk")
  self.effectDuration = config.getParameter("effectDuration", 180)
  self.foodValue = config.getParameter("foodValue", 30)
...
function finish()
  ...
  status.modifyResource("food", self.foodValue)
  status.removeEphemeralEffect(self.effectName)
