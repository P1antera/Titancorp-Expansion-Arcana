function init()
  ...
  self.itemName = config.getParameter("itemName", "at_ext_greentea")
  self.firstEffectName = config.getParameter("firstEffectName", "at_ext_greentea_1")
  self.firstEffectDuration = config.getParameter("firstEffectDuration", 60)
  self.secondEffectName = config.getParameter("secondEffectName", "at_ext_greentea_2")
  self.secondEffectDuration = config.getParameter("secondEffectDuration", 60)
  self.thirdEffectName = config.getParameter("thirdEffectName", "at_ext_greentea_3")
...
function finish()
  ...
  if activeEffects[self.thirdEffectName] then
    effectName = self.thirdEffectName
    effectDuration = self.thirdEffectDuration
  elseif activeEffects[self.secondEffectName] then
    effectName = self.thirdEffectName
    effectDuration = self.thirdEffectDuration
