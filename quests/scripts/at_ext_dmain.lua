...
require('/quests/scripts/at_ext_d.lua')
...
function init()
  local conditions = config.getParameter("conditions", {})
  storage.questSeed = storage.questSeed or math.random(#conditions)
...
function buildConditions()
  local conditions = {}
  local conditionsGroup = config.getParameter("conditions", {})
  local conditionConfig = conditionsGroup[storage.questSeed]
